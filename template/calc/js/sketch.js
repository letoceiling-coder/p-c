...
////console.log(png_img)
    ...
    function ajax() {
        ...
        var temp_ = texturesmanafacture.find(item => item.manufacturer_id == manufacturer && item.texture_id == texture && item.color == color && item.width == width_final)
        ...
        if (updateCeiling == true){
            ...
            newClient[$idElem].width_final = width_final
            ...
            newClient[$idElem].koordinats_poloten = koordinats_poloten
            newClient[$idElem].room_area = room_area
            newClient[$idElem].perimeter = perimeter
            newClient[$idElem].angles_count = angles_count
            newClient[$idElem].perimeter_shrink = perimeter_shrink
            newClient[$idElem].curvilinear_length = curvilinear_length
            newClient[$idElem].inner_cutout_length = inner_cutout_length
            newClient[$idElem].texture_id = temp_.texture_id
            newClient[$idElem].manufacturer_id = temp_.manufacturer_id
            newClient[$idElem].width_final = width_final
            newClient[$idElem].square_obrezkov = square_obrezkov
